...
public class MainActivity extends AppCompatActivity
    ...
    private class MyFragmentPagerAdampter extends FragmentPagerAdapter{

        String[] title = {"1st","2nd","3rd","4th"};
        ...
        @Override
        public int getCount() {
            return 4; // represent no of pages
        }
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // connection tablayput and viewpager
